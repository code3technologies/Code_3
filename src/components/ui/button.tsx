...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "hover:scale-105 bg-foreground text-primary-foreground hover:bg-primary   hover:border hover:border-accent", 
        destructive:
          "hover:scale-105 bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
        ...
        buttonWithGradientOnHover: "transform cursor-pointer rounded-full bg-black text-sm font-medium text-white duration-300 active:scale-[.95] hover:bg-gradient-to-br outline-none hover:from-black hover:to-white/40 hover:via-black sm:text-base",
        exploreLink: "text-primary_red/85 hover:text-primary_red/90 hover:cursor-pointer hover:scale-105 active:scale-100 font-medium duration-200 flex items-start gap-3 group p-0 h-auto justify-start w-max",
      },
      size: {
