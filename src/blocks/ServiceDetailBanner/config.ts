  ...
  fields: [
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'Cloud & Microsoft', value: 'cloud' },
        { label: 'Backup & Business Continuity', value: 'backup' },
        { label: 'IT Infrastructure / Data Centre', value: 'datacenter' },
        { label: 'Managed IT', value: 'managed' },
        { label: 'Hardware & Software', value: 'hardware' },
        { label: 'Audio Visual', value: 'av' },
        { label: 'Unified Communication', value: 'comms' },
